...
![](README_files/figure-gfm/unnamed-chunk-1-1.jpeg)<!-- -->
...
```
    ...
    ## 3:  five.param   2.117170        NA 11.126995  74.84174 0.11173194  -9265.572
    ## 4:        omvd   1.935855  91.84834  9.031137 131.70029 0.14819254  -5878.653
    ##           BIC          a        b        f
    ## 1: -15456.706         NA       NA       NA
    ## 2:  -5995.468         NA       NA       NA
    ## 3:  -9225.374 -0.5553554 12.94497 253.7784
    ## 4:  -5851.855         NA       NA       NA
...
```
    ...
    ## 1          2.236281       10.65918         1.367617 9.003802   3.022996
    ## 2          2.011040       10.44802         1.302814 8.976607   2.774225
    ## 3          1.816674       10.28483         1.221558 8.949552   2.556834
    ## 4          1.792297       10.14718         1.285380 8.922635   2.509925
    ## 5          1.843675       10.02616         1.408946 8.895857   2.539253
    ## 6          1.885111        9.91713         1.511196 8.869215   2.559111
...
The example below utilizes the `mmv.sample` data set that was generated
earlier and the `sessionMaxMeanSpeed` that is included in the package.
...
![](README_files/figure-gfm/unnamed-chunk-7-1.jpeg)<!-- -->
